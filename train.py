...
#train_dataset[-1]['components'] = np.array(h5py.File(join(path,dname,'seg-groundtruth2-myeline.h5'),'r')['main'])
...
dataset = randint(0, len(train_dataset) - 1)
print ('dataset:', dataset)
print ('datasetsize:', len(train_dataset))
print ('datasetshape:', train_dataset[ dataset ]['data'].shape)
...
if train['euclid']:
    print('starting euclid network training...')
    ...
    solverstates = pygt.getSolverStates(solver_config.snapshot_prefix);
    print('done training euclid network...')
