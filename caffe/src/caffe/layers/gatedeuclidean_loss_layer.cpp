...
void GatedEuclideanLossLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
...
template<typename Dtype>
void GatedEuclideanLossLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
                                            const vector<Blob<Dtype>*>& top) {
...
template<typename Dtype>
void GatedEuclideanLossLayer<Dtype>::Backward_cpu(
...
#ifdef CPU_ONLY
STUB_GPU(GatedEuclideanLossLayer);
#endif

INSTANTIATE_CLASS(GatedEuclideanLossLayer);
REGISTER_LAYER_CLASS(GatedEuclideanLoss);
