...
template <typename Dtype>
Dtype Solver<Dtype>::StepParallel(int_tp n_slices) {
...
template <typename Dtype>
Dtype Solver<Dtype>::StepForward(int_tp n_iters) {
...
template <typename Dtype>
void Solver<Dtype>::StepBackward(int_tp n_iters) {
