#ifndef GATEDCAFFE_EUCLIDEAN_LOSS_LAYER_HPP_
#define GATEDCAFFE_EUCLIDEAN_LOSS_LAYER_HPP_
 ...
 * input to a GatedEuclideanLossLayer exactly formulates a linear least squares
...
class GatedEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit GatedEuclideanLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "GatedEuclideanLoss"; }
  /**
   * Unlike most loss layers, in the GatedEuclideanLossLayer we can backpropagate
 ...
 protected:
  /// @copydoc GatedEuclideanLossLayer
   ...
   *
   * Unlike other children of LossLayer, GatedEuclideanLossLayer \b can compute
...
#endif  // GATEDCAFFE_EUCLIDEAN_LOSS_LAYER_HPP_
